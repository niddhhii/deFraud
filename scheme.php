...
<nav class="navbar navbar-expand navbar-light bg-primary topbar mb-4 static-top shadow">
    ...
    <ul class="navbar-nav ml-auto" style="font-size: 17px">
        <li class="nav-item no-arrow">
            <a class="nav-link" href="index.php" id="messagesDropdown" role="button" aria-haspopup="true" aria-expanded="false" style="font-size: 23px;padding: 25px; color: white">
                Home</a>
        </li>
        <li class="nav-item no-arrow">
            <a class="nav-link" href="#" id="messagesDropdown" role="button"  aria-haspopup="true" aria-expanded="false" style="font-size: 23px;padding: 25px; background-color: white;color: #000;">
                Schemes</a>
        </li>
    </ul>
</nav>
